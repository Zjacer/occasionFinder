...
xkomData.controller('xkomController', function($scope, $http) {
    $scope.xkomArrayData = ["res/brak.jpg", "", "BRAK DANYCH", "BRAK DANYCH", "BRAK DANYCH"];
...
moreleData.controller('moreleController', function($scope, $http) {
    ...
    $scope.moreleModel = {
        ItemSrc: "res/brak.jpg",
        ItemName: "",
        ItemLink: "BRAK DANYCH",
        OldPrice: "BRAK DANYCH",
        NewPrice: "BRAK DANYCH",
        Save: "BRAK DANYCH"
    };
    ...
    $http({
        ...
        if($scope.zadowolenieData = result.data.query.results !== null) {
...
zadowolenieData.controller('zadowolenieController', function($scope, $http) {
    $scope.zadowolenieArrayData = ["res/brak.jpg", "", "BRAK DANYCH", "BRAK DANYCH", "BRAK DANYCH"];
...
altoData.controller('altoController', function($scope, $http) {
    $scope.altoArrayData = ["res/brak.jpg", "", "BRAK DANYCH", "BRAK DANYCH", "BRAK DANYCH"];
...
amforaData.controller('amforaController', function($scope, $http) {
    $scope.amforaArrayData = ["res/brak.jpg", "", "BRAK DANYCH", "BRAK DANYCH", "BRAK DANYCH"];
